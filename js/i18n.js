...
export const TEXTS = {
  ...
  'resultados.sinResultado': { es: 'Aún no hay un análisis. Empezá completando el formulario.', en: 'No analysis yet. Start by filling out the form.' },
  ...
  'comparar.periodo1': { es: 'Período 1', en: 'Period 1' },
  'comparar.periodo2': { es: 'Período 2', en: 'Period 2' },
  'comparar.diff': { es: 'Diferencia', en: 'Difference' },
  'comparar.necesitas': { es: 'Necesitás al menos 2 análisis guardados para comparar.', en: 'You need at least 2 saved analyses to compare.' },
